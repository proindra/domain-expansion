    ...
    return (
        <div className={styles.page}>
            ...
            <Link to="/" className={styles.navLogo}>
                ...
                <div className={styles.navLogoText}>Domain Expansion</div>
            </Link>
            ...
            >
                ...
                <p className={styles.subtitle}>Join thousands of students mastering their studies.</p>
                ...
                <div className={styles.socialBtns}>
                    ...
                    <button className={styles.guestBtn} onClick={() => navigate('/app')}>
                        Continue as Guest
                    </button>
                </div>
